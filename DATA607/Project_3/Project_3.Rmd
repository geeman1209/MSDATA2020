---
title: "Project_3"
author: "Emerald Orcas - Gabe Abreu, Amit Kapoor & Devin Teran "
date: "3/17/2020"
...
We determined this is an appropriate dataset since it is employers that generally determine what are valued skill sets in an occupation.
...
Here we will get rid of unnecessary columns.  
```{r clean-data}
df_1 <- raw_data
...
The raw data originally had 6 columns, one for a different industry. If the job posting was within that industry, the column would be set to 1 if not, it was set to 0. We decided to combined these 6 columns into a single column 'Industry' with 6 different categories: Consulting.  
