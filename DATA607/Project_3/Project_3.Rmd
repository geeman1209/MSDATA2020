...
leadingtech <- c("python", "machine.learning", "r", "hadoop", "tableau", "spark")
...
raw_data %>% 
  ...
  ggplot()+
  geom_col(ggplot2::aes_string(x="key", y="count", fill="Job_Type"), width=0.5, position="dodge")+
  coord_flip()
...
#plot_mean_count(raw_data, leadingtech)
#radar_mean_count(raw_data, leadingtech)
```
