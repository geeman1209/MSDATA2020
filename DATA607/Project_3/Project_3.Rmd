...
Finally let's do a comparitive study for all 3 Job Types: data_analyst, data_engineer and data_scientist and the data science skills. The data shows Data Scientist has mostly all the skills of Data Analyst and Data Engineer. It would be interesting to know what 'Others' skill includes.
