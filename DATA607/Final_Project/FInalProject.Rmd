...
```{r day}
tidy_data %>% select(date,day) %>% filter(day == 16)

trump_apprsubdf %>% filter(modeldate == '2020-04-02')
trump_apprsubdf %>% filter(modeldate == '2020-04-03')
trump_apprsubdf %>% filter(modeldate == '2020-04-04')
```
### Comparing Lexicons
